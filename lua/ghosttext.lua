...
local function str_to_start(str)
    return vim.str_utfindex(str,"utf-16")
end
...
function M._start_http_server(opts)
...
function M.start(opts)
    ...
    M._start_websocket_server(opts)
    M._request_focus(opts)
